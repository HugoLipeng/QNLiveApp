package com.qiniu.hugo.qnlive.register;
...
import com.qiniu.hugo.qnlive.editprofile.EditProfileActivity;
import com.qiniu.hugo.qnlive.R;
import com.qiniu.hugo.qnlive.login.LoginActivity;
    ...
    private void getSelfInfo() {
        TIMFriendshipManager.getInstance().getSelfProfile(new TIMValueCallBack<TIMUserProfile>() {
            ...
            public void onSuccess(TIMUserProfile timUserProfile) {
                //获取自己信息成功
                QNApplication.getApplication().setSelfProfile(timUserProfile);
            }
        });
    }
}
